...
[![A three-dimensional conceptual exhibit: a physical world, finite measurement aperture, memory and belief lenses, an observer inside that world, and an action returning to it.](observer-lens.jpg)](observer-lens.jpg)
...
<sub>AI-generated 3D illustration, not a physical simulation or image of consciousness. The lens curvature is a visual metaphor for measurement and representation. No claim that observation necessarily falsifies a reading, or that belief bends spacetime. The equations below specify the actual relationships.</sub>
...
<sub>Exhibit version 2026-09-14-lens-1. Programme manuscript sources are not independent replications; retained PDF page numbers and hashes identify revisions. The source map includes older manuscripts, so repeated records are not independent discoveries.</sub>
